...
See you there! ☕`),p="917814498149",g=`https://www.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(s.title+" — Heebee Sessions")}&dates=${s.date.replace(/-/g,"")}T${s.time.replace(":","")}00/${s.date.replace(/-/g,"")}T${s.time.replace(":","")}00&location=${encodeURIComponent(s.outlet)}`;a.innerHTML=`
